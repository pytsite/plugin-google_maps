...
window.pytsiteGoogleMapsInit = function () {
    pytsite.browser.loadAssets([
        'google_maps@js/google-maps-InfoBox.min.js',
        'google_maps@js/google-maps-MarkerWithLabel.min.js',
        'google_maps@js/google-maps-RichMarker.min.js'
    ]).done(function () {
...
window.pytsiteGoogleMap = function (mapNode, options) {
    var self = this;

    if (mapNode instanceof jQuery)
        mapNode = mapNode[0];
